...
//	animalNames.push(item.scientific_name);
});
...
const lowerCase = zooAnimals.map(function(stuff) {
	return stuff.animal_name.toLowerCase();
});
...
const largerPopulation = zooAnimals.filter(function (thing) {
